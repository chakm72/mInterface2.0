...
public class mLocationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        LocationListener locationListener = new mLocationService.MyLocationListener(locationManager);
    ...
    private class MyLocationListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            new mLocationService.UpdateLocation(Double.toString(location.getLatitude()), Double.toString(location.getLongitude())).execute("");
            if (isConnected()) {
                new mLocationService.SendLocation().execute();
            }
        }
        @ Override
    ...
    public void onLowMemory() {
        super.onLowMemory();
        startService(new Intent(getApplicationContext(), mLocationService.class));
    }
